package com.example.bassam.sporstincmanger.FloatingActionButton;
...
public class Main2ActivityFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        programFab1.setImageResource(R.drawable.ic_create_white_24dp);
        ...
        programFab2.setImageResource(R.drawable.ic_create_white_24dp);
        ...
        scaleInX.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationStart(Animator animation) {
                menuGreen.getMenuIconView().setImageResource(menuGreen.isOpened()
                        ? R.drawable.ic_close : R.drawable.ic_create_white_24dp);
            }
        });
